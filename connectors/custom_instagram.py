...
class Messenger:
    print(
        "fmdskfmdsfmsd fdksflk sdflsdkf lsdkfsdkflksdf"
    )
    @classmethod
    def name(cls) -> Text:
        return "instagram"
    ...
    async def handle(self, payload: Dict, metadata: Optional[Dict[Text, Any]]) -> None:
        for entry in payload["entry"]:
            ...
            for message in entry["messaging"]:
                print(message,"popdsfjdlsjfkjdsjf------------------------")
    ...
    async def message(
        ...
        if self._is_quick_reply_message(message):
            ...
            return
        print()
        print(message,"______________ global message-----------------------------")
        print(text,"---------------- global text ------------------------------")
...
class MessengerBot(OutputChannel):
    print("nfndsfdsknf fdklsfj klsdjf sdjfkls djf")
    @classmethod
    def name(cls) -> Text:
        return "instagram"
    ...
    async def send_quick_replies(
        ...
        **kwargs: Any,
        ...
        print(quick_replies,"----00009090900999909990909999090909090099099990998877889")
...
class InstagramInput(InputChannel):
    print("gdsudsjdhsdjshdshdsdnskjdnsjkh")
    @classmethod
    def name(cls) -> Text:
        return "instagram"
    ...
    def from_credentials(cls, credentials: Optional[Dict[Text, Any]]) -> InputChannel:
        if not credentials:
            print(cls.raise_missing_credentials_exception,"smnfdsnfdsnfdsnf--------------")
            cls.raise_missing_credentials_exception()
    
        print(credentials.get("verify"), "??????")
...
print("cfdnfsdkfnkdsfndslnfdsfnsdfdsn")
